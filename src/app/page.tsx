          ...
          <div className="py-2">
            <div>
              <div className="grid grid-cols-[50px_1fr] md:grid-cols-[70px_1fr] items-stretch w-full py-2 pl-0 md:pl-2 md:px-2 pr-2">
                <div></div>
                <span className="text-sm font-helvetica">Aug 11 - 24</span>
              </div>
              <div>
                <div className="grid grid-cols-[50px_1fr] md:grid-cols-[70px_1fr] items-stretch w-full py-2 pl-0 md:pl-2 md:px-2 pr-2">
                  ...
                  <div className="flex-1">
                    <div className="w-full flex gap-2 items-stretch py-2 px-4 bg-green-800 text-white rounded-xl ">
                      <div className="text-sm font-helvetica flex-1">
                        <p
                          className="font-semibold line-clamp-2"
                          title="Annual Tech Conference 2024 Is a long name that can be an
                      edge case name that can be an edge case name that can be
                      an edge case"
                        >
                          Annual Tech Conference 2024 Is a long name that can be
                          an edge case name that can be an edge case name that
                          can be an edge case
                        </p>
                      ...
                      <div className="flex items-center flex-shrink-0">
                        <div className="w-8 h-8 rounded-full">
                          <Image
                            ...
                            width={140}
                            height={140}
                            src="/assets/images/month/july.webp"
                            alt=""
                          />
                        </div>
                      </div>
